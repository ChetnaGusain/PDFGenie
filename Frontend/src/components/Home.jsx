    ...
    container px-6 py-3 md:px-40'>
        <div className='flex h-screen items-center justify-center'>
            ...
            <div className='flex flex-col items-center space-y-4'>
                ...
                disabled={!selectedFile} className='text-white bg-blue-500 hover:bg-blue-700
                disabled:bg-gray-400 disabled:pointer-events-none duration-300 font-bold px-4 py-2
                rounded-lg'>
                    Convert File
                </button>
                {convert && (
                ...
                {downloadError && (
                    <div className='text-green-500 text-center'>{downloadError}</div>
                    )}
            </div>
            </div>
        </div>
